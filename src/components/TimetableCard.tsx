...
export default function TimetableCard({
  ...
  return (
    <View className="w-full border-b border-b-stroke/20 p-2">
      <View className="flex-1">
        ...
        <View className="flex-row border rounded-lg justify-around divide-x my-2">
          <View className=" flex-1 justify-center items-center">
            <Text className="text-text font-medium text-xs px-2">{block}</Text>
          </View>
          <View className=" flex-1 justify-center items-center">
            <Text className="text-text font-medium text-xs px-1">{room}</Text>
          </View>
          <View className="px-2">
            <Text className="text-text font-medium text-xs px-1">{time}</Text>
          </View>
        </View>
